...
export default function CPACalculatorPage() {
  const t = useTranslations("tools.cpa.page");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/50 to-background">
      <div className="container mx-auto px-4 py-8">
        {/* Hero Section */}
        <ToolPageHero namespace="tools.cpa.hero" />
        ...
        {/* Features Section */}
        <ToolFeatures namespace="tools.cpa.features" features={features} />

        {/* Showcase Section */}
        <ToolShowcase namespace="tools.cpa.showcase" />

        {/* Features2 Section */}
        <ToolFeatures2 namespace="tools.cpa.features2" items={features2} />




        {/* FAQ Section */}
        <ToolFAQ namespace="tools.cpa.faq" />

        {/* CTA Section */}
        <ToolCTA namespace="tools.cpa.cta" />
      </div>
    </div>
  );
}
