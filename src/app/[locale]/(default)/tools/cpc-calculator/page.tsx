  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/50 to-background">
      <div className="container mx-auto px-4 py-8">
        {/* Hero Section */}
        <ToolPageHero namespace="tools.cpc.hero" />
        ...
        {/* Features Section */}
        <ToolFeatures namespace="tools.cpc.features" features={features} />

        {/* Showcase Section */}
        <ToolShowcase namespace="tools.cpc.showcase" />

        {/* Features2 Section */}
        <ToolFeatures2 namespace="tools.cpc.features2" items={features2} />




        {/* FAQ Section */}
        <ToolFAQ namespace="tools.cpc.faq" />

        {/* CTA Section */}
        <ToolCTA namespace="tools.cpc.cta" />
      </div>
    </div>
  );
}
